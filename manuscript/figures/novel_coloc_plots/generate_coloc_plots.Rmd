...
temp_plot
ggsave("LC_novel_coloc_plot.pdf", plot = temp_plot, width = 3, height = 3)
```
...
temp_plot <- ggplot(gwas_colocs, aes(x = sample_size, y = n_unique_novel_ld_blocks, label=qtl_subset)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
temp_plot
ggsave("Height_novel_coloc_plot.pdf", plot = temp_plot, width = 3, height = 3)
```
...
temp_plot_violin <- ggplot(novel_ld_block_based_counts_all_gwas_filt, 
    ...
    ggplot2::labs(x="Novel LD block count / sample size", 
                  y="GWAS") +
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
ggsave("coloc_violin.pdf", plot = temp_plot_violin, width = 5, height = 6.5)
