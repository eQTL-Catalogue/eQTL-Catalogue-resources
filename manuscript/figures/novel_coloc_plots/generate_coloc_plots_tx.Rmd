...
qtl_group_samplesizes <- read_tsv("data/qtl_group_samplesizes_tx.tsv")
...
```{r}
GTExV8_sign_colocs <- read_tsv("data/GTExV8_sign_colocs_tx.tsv.gz")
eqtlCat_all_sign_colocs <- read_tsv("data/tx_sign_colocs.tsv.gz")
```
...
write_tsv(novel_ld_block_colocs, "data/novel_eqtlcat_tx_colocs_in_novel_ldblocks_relative_to_GTExV8.tsv")
```
...
qtlsubset_classes <- read_tsv("data/qtl_subset_classes_tx.tsv")
...
novel_ld_block_based_counts %>%
  ...
  write_tsv("data/novel_ld_block_based_counts_tx.tsv")
...
write_tsv(novel_ld_block_counts, "data/novel_ld_blocks_counts_by_gwas_tx.tsv")
...
htmlwidgets::saveWidget(widget = plotly::as_widget(ggplotly_plot),
                        file = file.path(normalizePath(paste0(output_dir, "/plotly")), "novel_ld_blocks_proportions_tx.html"),
                        libdir = "dependencies")
...
ggsave("manuscript_needed_plots/novel_LD_block_proportions_tx.pdf", plot = plot_distinct_counts, width = 7, height = 4, device = "pdf")
...
write_tsv(novel_ld_block_based_counts_all_gwas, "data/novel_ld_blocks_tx_classified.tsv")
...
ggsave("manuscript_needed_plots/coloc_violin_tx.pdf", plot = temp_plot_violin, width = 5, height = 6.5)
