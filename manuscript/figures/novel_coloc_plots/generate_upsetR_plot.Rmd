...
microarray_datasets <- c(
    "CEDAR.B-cell_CD19_microarray",
    "CEDAR.ileum_microarray",
    "CEDAR.monocyte_CD14_microarray",
    "CEDAR.neutrophil_CD15_microarray",
    "CEDAR.platelet_microarray",
    "CEDAR.rectum_microarray",
    "CEDAR.T-cell_CD4_microarray",
    "CEDAR.T-cell_CD8_microarray",
    "CEDAR.transverse_colon_microarray",
    "Fairfax_2012.B-cell_CD19_microarray",
    "Fairfax_2014.monocyte_IFN24_microarray",
    "Fairfax_2014.monocyte_LPS2_microarray",
    "Fairfax_2014.monocyte_LPS24_microarray",
    "Fairfax_2014.monocyte_naive_microarray",
    "Kasela_2017.T-cell_CD4_microarray",
    "Kasela_2017.T-cell_CD8_microarray",
    "Naranbhai_2015.neutrophil_CD16_microarray"
  )
...
eqtlCat_rnaseq_sign_colocs_ge_with_ma <- rbind(read_tsv("data/eqtlCat_all_sign_colocs_maxbeta.tsv.gz"), read_tsv("data/GTExV8_sign_colocs_maxbeta.tsv.gz"))
...
eqtlCat_rnaseq_sign_colocs_ge <- eqtlCat_rnaseq_sign_colocs_ge %>% filter(!qtl_subset %in% microarray_datasets)
