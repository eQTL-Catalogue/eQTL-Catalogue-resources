...
# ggsave(filename = "../../temp_files/var_multi_gene_reg/plots/cc_reg_gene_counts.pdf", 
#        plot = genes_reg_by_each_cc_facet, device = "pdf")
```
...
# ggsave(filename = "../../temp_files/var_multi_gene_reg/plots/cc_reg_cs_counts.pdf", 
#        plot = cs_reg_by_each_cc_facet, device = "pdf")
