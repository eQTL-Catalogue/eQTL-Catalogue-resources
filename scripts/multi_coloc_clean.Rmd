...
```
```{r add_CD40_transcript_location}
...
save_ggplots(plot = joint_plot, path = "../paper_plots/eQTL_api_usecase/", filename = "new_tx_merged_plot_with_exon", height = 28, width = 15)
```
...
# font_styles <- c(rep("plain", 6), "bold", rep("plain", 7))
# y_tick_colors <- c(rep("black", 6), "blue", rep("black", 7))
...
# theme(axis.text.y = element_text(face = font_styles, colour = y_tick_colors))
# size = c(15,rep(8,5))

save_ggplots(plot = final_plot, path = "../paper_plots/eQTL_api_usecase/", filename = "sign_eqtl_scatter_shape", height = 10, width = 18)
